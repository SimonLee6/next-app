    ...
    <div className={style.aboutWrap}>
      <div className={style.about1}>
        ...
        <div className={style.aboutCard}>
          ...
          <p className={style.pStyle}>记仇的天蝎座 ? 非计算机专业, base北京, 毕业半跨界在FrontEnd的路上越走越远...</p>
          <p className={style.pStyle}>来自碳水的天堂 ? 陕西, 羊肉泡馍, 凉皮肉夹馍, biangbiang面, 不要太香...</p>
          <p className={style.pStyle}>我要把你筑进兵马俑里, 因为我是浪漫的陕西人, 哈哈哈哈</p>
        </div>
        <div className={style.aboutCard}>
          <p className={style.subTitle}>天蝎座性格</p>
          <p className={style.pStyle}>外冷内热型, 喜欢独处, 向往自由, 又时候会比较极端, 记仇? 对我来说睡一觉就好了, 哈哈哈</p>
          <p className={style.pStyle}>需要目标, 不然会有点无所事事, 有目标就不会轻易放手, 不达到目的誓不罢休</p>
        </div>
        <div className={style.aboutCard}>
        <p className={style.subTitle}>摄影爱好者</p>
          <p className={style.pStyle}>索尼大法, 喜欢用镜头记录生活的美好, 人文, 风光, 建筑... 周末没事就出去扫街, 有大佬带带我...</p>
          <p className={style.pStyle}>不过我还是喜欢一个人出去拍拍, 哈哈哈</p>
        </div>
      </div>
      ...
      <div className={style.about2}>
        ...
        <p className={style.pStyle}>邮箱: isimon1114@163.com</p>
        <p className={style.pStyle}>或者留言都可以</p>
      </div>
      <div className={style.about2}>
        <h1 className={style.aboutTitle}>站主其他联系方式</h1>
        <div>
          <p className={style.pStyle}><a href="https://juejin.cn/user/1239904846876189" target="__blank">掘金</a></p>
          <p className={style.pStyle}><a href="https://segmentfault.com/u/isimon123" target="__blank">思否</a></p>
          <p className={style.pStyle}><a href="https://github.com/SimonLee6" target="__blank">github</a></p>
          <p className={style.pStyle}>欢迎关注</p>
        </div>
      </div>
      <div className={style.about2}>
